        ...
        <>
            <div className="container">
                ...
                <div className='main-section'>
                    <div className='box'>
                        <h3>Projects</h3>
                           <div className='box'>Html only portfolio</div>
                         
                            <div className='box6'>Calculator</div>
                            <div className='box7'>Quiz app</div>
                            <div className='box8'>countdown Timer</div>
                            <div className='9'>product upcoming page</div>
